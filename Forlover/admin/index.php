      ...
      <div class="panel panel-primary">
        <div class="panel-heading"><h3 class="panel-title">后台管理首页</h3></div>
          <ul class="list-group">
			...
			<li class="list-group-item"><span class="glyphicon glyphicon-stats"></span> <b></b>说明：<p><iframe src="https://yun.sillyli.com/forlover/info.php" style="width:100%;height:150px;"></iframe></p></li>
          </ul>
      </div>
