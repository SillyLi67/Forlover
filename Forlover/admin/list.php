    ...
    <div class="container">
      ...
      <div id="navbar" class="collapse navbar-collapse">
        <ul class="nav navbar-nav navbar-right">
		  ...
		  <li class="active">
            <a href="./list.php"><span class="glyphicon glyphicon-list"></span> 告白列表</a>
          </li>
		  <li>
...
<div class="panel-heading"><h3 class="panel-title">修改告白信息</h3></div>';
...
value="确定修改"></form>
';
echo '<br/><a href="./list.php">>>返回告白列表</a>';
echo '</div></div>
<script>
...
echo '<div class="alert alert-info">目前系统共有'.$numrows.'条告白。<br/>';
echo '</div>';
...
?>
      <div class="table-responsive">
        <table class="table table-striped">
          <thead><tr><th>操作</th><th>序号</th><th>内容</th><th>获赞</th><th>昵称</th><th>表白对象</th><th>QQ</th><th>时间</th></thead>
          <tbody>
<?php
$pagesize=30;
...
{
$edit = '<a class="btn btn-primary" href="list.php?or=edit&id='.$res['id'].'" title="修改"><i class="fa fa-edit"></i>&nbsp;修改</a><a class="btn btn-danger" href="list.php?or=del&id='.$res['id'].'" title="删除此表白"><i class="fa fa-del">&nbsp;删除</i></a>';
